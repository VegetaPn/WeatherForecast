...
public class WeatherMainActivity extends BaseActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mLocationClient.registerLocationListener( myListener );				//◊¢≤·º‡Ã˝∫Ø ˝
		...
		.commit();
		vp.setCurrentItem(0);//ËÆæÁΩÆÂêØÂä®È°µÈù¢
	...
	public class WeatherPagerAdapter extends FragmentPagerAdapter {
		...
		public Object instantiateItem(ViewGroup container,int position) {
		    ...
		    if(fragment.getTag() != mFragments.get(position).getTag()){
			    ...
			    //ÁßªÈô§ÊóßÁöÑfragment
			    ft.remove(fragment);
			    fragment=mFragments.get(position);
			    //Êç¢ÊàêÊñ∞ÁöÑfragment
			...
			public void handleMessage(Message msg) {
				...
				if(msg.what==0)
				{
					...
					if(cityWeather!=null)
					{
						...
						remoteViews.setTextViewText(R.id.textViewNotificationTemNow, cityWeather.getNtmp()+"°Ê");
				    	...
				    	notification.tickerText="ΩÒ»’Œ¬∂»£∫"+cityWeather.getNtmp()+"°Ê";
